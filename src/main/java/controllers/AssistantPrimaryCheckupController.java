...
public class AssistantPrimaryCheckupController {
    ...
    @FXML private TextField patientIdField;   // new: patient_id input
    @FXML private TextField patientNameField; // just for reference (not inserted)
    @FXML private TextField contactNoField;   // just for reference (not inserted)
    @FXML private TextField weightField;
    @FXML private TextField ageField;
    @FXML private TextField bloodPressureField;

    private int assistantId; // dynamic from login
