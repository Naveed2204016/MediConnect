...
public class doctor_emergency_requestcontroller {
    public TableView emergency_req;
    ...
    public void initialize() {
        ...
        emergencyRequests1.add(new EmergencyRequest("P001", "Chest Pain", "123-456-7890"));
        emergencyRequests1.add(new EmergencyRequest("P002", "Severe Headache", "987-654-3210"));
        emergencyRequests1.add(new EmergencyRequest("P003", "Accident Injury", "555-123-4567"));

        // Set the data to the TableView
        emergency_req.setItems(emergencyRequests1);
    }

    public void accept_req(ActionEvent actionEvent) {
        EmergencyRequest selectedRequest = (EmergencyRequest) emergency_req.getSelectionModel().getSelectedItem();
        if (selectedRequest != null) {
            ...
            emergencyRequests1.remove(selectedRequest);
    ...
    public void reject_req(ActionEvent actionEvent) {
        EmergencyRequest selectedRequest = (EmergencyRequest) emergency_req.getSelectionModel().getSelectedItem();
        if (selectedRequest != null) {
